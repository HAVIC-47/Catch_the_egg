// Catch The Eggs part 3 - + Chicken bob + chicken movement + basket mouse/key control
// Build: g++ "Catch The Eggs part 3.cpp" -o "Catch The Eggs part 3.exe" -lfreeglut -lopengl32 -lglu32 -lwinmm
#include <windows.h>
#include <GL/glut.h>
#include <math.h>
#include <stdio.h>
...
struct Chick { float x,y,sp,bp; int dir; };
...
void keyboard(unsigned char k,int x,int y){ keys[k]=true; (void)x;(void)y; if(k==27) exit(0); }
...
int main(int argc,char** argv){
    ...
    glutCreateWindow("Catch The Eggs - Part 3");
