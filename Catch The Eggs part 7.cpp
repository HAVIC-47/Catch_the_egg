// Catch The Eggs part 7 - + Menus, level select, help, pause, 6 levels w/ themes, high-score I/O
// Build: g++ "Catch The Eggs part 7.cpp" -o "Catch The Eggs part 7.exe" -lfreeglut -lopengl32 -lglu32 -lwinmm
#include <windows.h>
#include <GL/glut.h>
#include <math.h>
#include <stdio.h>
...
// === 6. Audio stub (no-op; full audio added in Part 8) ===
void playSfx(int k){ (void)k; }
...
int main(int argc,char** argv){
    ...
    glutCreateWindow("Catch The Eggs - Part 7");
    glutFullScreen();
